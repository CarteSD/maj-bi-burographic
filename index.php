...
$html .= '<div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 15px;">
    ...
    <button type="submit" class="ignore-btn"' . (empty($lignesAMettreAJour) ? ' disabled' : '') . '>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41z"/></svg>
        Ignorer la sélection
    </button>
    <button type="button" onclick="document.getElementById(\'update-form\').submit();" class="update-all-btn"' . (empty($lignesAMettreAJour) ? ' disabled' : '') . '>
